...
namespace XLua
{
    ...
    public class LuaEnv : IDisposable
    {
        ...
        //loader : CustomLoader｣ｬ filepathｲﾎﾊ｣ｺ｣ｨrefﾀ獎ﾍ｣ｩﾊ菠・ﾇrequireｵﾄｲﾎﾊ｣ｬﾈ郢鋗靨ｪﾖｧｳﾖｵﾔ｣ｬﾐ靨ｪﾊ莎賁ｵﾂｷｾｶ｡｣
        //                        ｷｵｻﾘﾖｵ｣ｺﾈ郢都ｵｻﾘnull｣ｬｴ﨑晴ﾓﾔﾘｸﾃﾔｴﾏﾂﾎﾞｺﾏﾊﾊｵﾄﾎﾄｼ｣ｬｷｵｻﾘUTF8ｱ狡・ﾄbyte[]
